...
namespace API.Services.Interfaces
{
    ...
    {
        public Task<(string, bool)> Buy(string userId, List<Connection> connections, string targetName, string targetSurname);
        ...
        public Task<(string, bool)> Add(string userId, List<Connection> connections, string targetName, string targetSurname);
