...
namespace API.Services.Interfaces
{
    ...
    {
        public Task<(string, bool)> Buy(string userId, List<string> connectionsIds, string targetName, string targetSurname, int seat);
        ...
        public Task<(string, bool)> Add(string userId, List<string> connectionsIds, string targetName, string targetSurname, int seat);
