...
import SeatsContainer from "./SeatsContainer.jsx";
const TicketConfirmation = ({ navigation, route }) => { // here there is USERS id
    ...
    const [seatNumberTranlated, setSeatNumberTranslated] = useState('');

    function saveSeat(seatNumber, seatNumberTranlated){
        setSeatNumber(seatNumber);
        setSeatNumberTranslated(seatNumberTranlated);
    }
    ...
    const handleBuyButtonClick = async () => {
        ...
        const requestBody = {
            ...
            seat: String(seatNumberTranlated)
        };

        console.log('oho');
        console.log(requestBody.seat);
                    ...
                    <div className="TravelTimeInfo" key={index}>
                        <div className="separator">
                            ...
                            <div className="stationItem">
                                ...
                                <TrainInfo trainNumber={singleConnection.providerName} wagonNumber={ticketData.wagonNumber} seatNumber={seatNumber} />
    ...
    return (
        <div>
            ...
            <form onSubmit={handleBuyButtonClick}>
                ...
                {allConnections.length > 0 && <SeatsContainer connectionId={allConnections[0].id} saveSeat={saveSeat}/>}
                <div className="TravelTravelerInfo">
                    <h3>Dane podróżującego</h3>
                    <h3>{seatNumberTranlated}</h3>
                    <div className="ticket-details">
                        <div className="icon">
